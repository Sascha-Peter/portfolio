...
from .views import SkillCategoryView
...
class SkillTestCase(TestCase):
    ...
    def test_skills_in_category(self):
        ...
        Skill.objects.create(skill_name="Python", skill_category=skill_category)
        Skill.objects.create(skill_name="Django", skill_category=skill_category)
        response = self.client.get(reverse('home'))
